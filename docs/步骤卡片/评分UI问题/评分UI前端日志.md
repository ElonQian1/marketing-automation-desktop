...
elementTransform.ts:116 ✅ [convertVisualToUIElement] indexPath 已保留: {id: 'element_3', hasIndexPath: true, indexPathLength: 3}
 ✅ [convertVisualToUIElement] indexPath 已保留: {id: 'element_4', hasIndexPath: true, indexPathLength: 4}
 ...
 🔍 [convertVisualToUIElement] 输入元素检查: {id: 'element_32', hasIndexPath: true, indexPath: Array(22), indexPathLength: 22, elementKeys: Array(16)}
 ...
 ✅ [convertVisualToUIElement] indexPath 已保留: {id: 'element_63', hasIndexPath: true, indexPathLength: 11}
 ✅ [convertVisualToUIElement] indexPath 已保留: {id: 'element_62', hasIndexPath: true, indexPathLength: 12}
 ✅ [convertVisualToUIElement] indexPath 已保留: {id: 'element_1', hasIndexPath: true, indexPathLength: 1}
 ✅ [convertVisualToUIElement] indexPath 已保留: {id: 'element_2', hasIndexPath: true, indexPathLength: 2}
 ✅ [convertVisualToUIElement] indexPath 已保留: {id: 'element_3', hasIndexPath: true, indexPathLength: 3}
 ✅ [convertVisualToUIElement] indexPath 已保留: {id: 'element_4', hasIndexPath: true, indexPathLength: 4}
 ✅ [convertVisualToUIElement] indexPath 已保留: {id: 'element_5', hasIndexPath: true, indexPathLength: 5}
 ✅ [convertVisualToUIElement] indexPath 已保留: {id: 'element_6', hasIndexPath: true, indexPathLength: 6}
 ✅ [convertVisualToUIElement] indexPath 已保留: {id: 'element_7', hasIndexPath: true, indexPathLength: 7}
...
use-intelligent-analysis-workflow.ts:866 🎯 [Workflow] 创建快速步骤卡片 {stepId: '1763521205492_49wp0fadk', context: {…}, lockContainer: false}
...
stepcards.ts:313 📝 [StepCardStore] 创建步骤卡片（新方式） {stepId: '1763521205492_49wp0fadk', cardId: 'card_1763521205827_ilm48hf3v', data: {…}}
use-intelligent-analysis-workflow.ts:946 🔗 [Bridge] 在统一store中创建对应卡片 {stepId: '1763521205492_49wp0fadk', unifiedCardId: 'card_1763521205827_ilm48hf3v', elementUid: '1763521205492_49wp0fadk', hasOriginalElement: true}
...
dispatchEvent @ react-dom-client.development.js:20658
dispatchDiscreteEvent @ react-dom-client.development.js:20626
intelligent-analysis-backend.ts:215 🚀 [BackendService] 启动智能分析（缓存未命中/降级） {element_context: {…}, step_id: '1763521205492_49wp0fadk', lock_container: false, enable_smart_candidates: true, enable_static_candidates: true}
...
devTracer.ts:42 [EVT] analysis:progress {job_id: 'ff23829c-5b1e-49c3-b056-1913692819d1', progress: 5, current_step: '初始化分析环境', estimated_time_left: 4750}
logger-config.ts:50 ⚠️ [Workflow] 收到未知任务的进度更新: v3-unknown {jobId: 'v3-unknown', currentJobs: Array(0)}
devTracer.ts:42 [EVT] analysis:progress {job_id: 'ff23829c-5b1e-49c3-b056-1913692819d1', progress: 5, current_step: '初始化分析环境', estimated_time_left: 4750}
logger-config.ts:50 ⚠️ [Workflow] 收到未知任务的进度更新: ff23829c-5b1e-49c3-b056-1913692819d1 {jobId: 'ff23829c-5b1e-49c3-b056-1913692819d1', currentJobs: Array(0)}
 🧹 [V3 BackendService] 清理事件监听器 1
 🔧 [EventSetup] 使用V3事件监听系统
 🔧 [V3 BackendService] 设置进度事件监听器
 ✅ [BackendService] 分析任务已启动 {job_id: 'ff23829c-5b1e-49c3-b056-1913692819d1', selection_hash: '6e57b50d12fa', state: 'running'}
 ✅ [V2 回退] 成功回退到V2系统执行 {jobId: 'ff23829c-5b1e-49c3-b056-1913692819d1'}
 ✅ [步骤创建] 验证增强后的数据传递: {原始_element_text: '', 增强_context_elementText: '', 原始_element_content_desc: '', 增强_context_content_desc: '', 最终使用_text: '', …}
 🏷️ [智能命名] 生成步骤名称: {原始element_text: '', 增强enrichedText: '', 原始element_content_desc: '', 增强enrichedContentDesc: '', 是否中层容器: '', …}
  ⚠️ [智能命名] 无法找到元素文本，使用通用名称，应触发后端智能分析: element_27
generateSmartName @ useIntelligentStepCardIntegration.ts:630
(匿名) @ useIntelligentStepCardIntegration.ts:650
 🔄 [智能集成] 添加步骤前，当前步骤数量: 0
 ✅ [智能集成] 步骤卡创建成功: {stepId: '1763521205492_49wp0fadk', elementId: 'element_27', analysisStarted: true, addedToMainList: true, currentStepsCount: 0, …}
 🚪 [智能集成] 已关闭页面查找器
 [EVT] analysis:progress {job_id: 'ff23829c-5b1e-49c3-b056-1913692819d1', progress: 25, current_step: '解析页面结构', estimated_time_left: 3750}
  [TAURI] Couldn't find callback id 2723542990. This might happen when the app is reloaded while Rust is running an asynchronous operation.
runCallback @ 未知
value @ 未知
(匿名) @ 未知
(匿名) @ 未知
 [EVT] analysis:progress {job_id: 'ff23829c-5b1e-49c3-b056-1913692819d1', progress: 25, current_step: '解析页面结构', estimated_time_left: 3750}
 🔄 [智能集成] 添加步骤后，新步骤数量: 1
 🔄 [智能集成] 新步骤详情: {id: '1763521205492_49wp0fadk', name: '智能操作 1', step_type: 'smart_find_element', description: '智能分析 - element_27', enableStrategySelector: true, …}
 🔄 [智能集成] 添加步骤后，新步骤数量: 1
 🔄 [智能集成] 新步骤详情: {id: '1763521205492_49wp0fadk', name: '智能操作 1', step_type: 'smart_find_element', description: '智能分析 - element_27', enableStrategySelector: true, …}
  Warning: [antd: Modal] `destroyOnClose` is deprecated. Please use `destroyOnHidden` instead.
warning @ chunk-LIT54SYV.js?v=0baf209e:613
call @ chunk-LIT54SYV.js?v=0baf209e:632
warningOnce @ chunk-LIT54SYV.js?v=0baf209e:637
_warning @ chunk-LIT54SYV.js?v=0baf209e:3284
typeWarning @ chunk-LIT54SYV.js?v=0baf209e:3311
typeWarning.deprecated @ chunk-LIT54SYV.js?v=0baf209e:3316
(匿名) @ chunk-LIT54SYV.js?v=0baf209e:20288
Modal @ chunk-LIT54SYV.js?v=0baf209e:20287
react_stack_bottom_frame @ chunk-JQKKP4PT.js?v=0baf209e:17424
renderWithHooks @ chunk-JQKKP4PT.js?v=0baf209e:4206
updateFunctionComponent @ chunk-JQKKP4PT.js?v=0baf209e:6619
beginWork @ chunk-JQKKP4PT.js?v=0baf209e:7654
runWithFiberInDEV @ chunk-JQKKP4PT.js?v=0baf209e:1485
performUnitOfWork @ chunk-JQKKP4PT.js?v=0baf209e:10868
workLoopSync @ chunk-JQKKP4PT.js?v=0baf209e:10728
renderRootSync @ chunk-JQKKP4PT.js?v=0baf209e:10711
performWorkOnRoot @ chunk-JQKKP4PT.js?v=0baf209e:10330
performWorkOnRootViaSchedulerTask @ chunk-JQKKP4PT.js?v=0baf209e:11623
performWorkUntilDeadline @ chunk-JQKKP4PT.js?v=0baf209e:36
 🧹 [V3 BackendService] 清理事件监听器 0
 🔧 [EventSetup] 使用V2事件监听系统
 ...
 🔍 [CompactStrategyMenu] 准备模态框数据:
   stepId: 1763521205492_49wp0fadk
   unifiedElementData: null
   dataLoading: false
   dataError: null
 🔍 Fallback 1 检查: {stepId: '1763521205492_49wp0fadk', cardId: 'card_1763521205827_ilm48hf3v', hasCard: true, hasOriginalElement: true, cardKeys: Array(10), …}
 ...
 🔍 Fallback 1 检查: {stepId: '1763521205492_49wp0fadk', cardId: 'card_1763521205827_ilm48hf3v', hasCard: true, hasOriginalElement: true, cardKeys: Array(10), …}
 ⚠️ Fallback 1: 使用步骤卡片数据 {id: 'element_27', element_type: 'content_other', text: '', bounds: {…}, resource_id: '', …}
 ✅ [V3 BackendService] 完成事件监听器已设置
 ⚠️ [V3 BackendService] V3不单独发射error事件，错误包含在complete事件中
 🔍 [菜单显示] Step1 - 卡片子树评分: {candidateKey: 'card_subtree_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
 🔍 [菜单显示] Step2 - 叶子上下文评分: {candidateKey: 'leaf_context_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
 🔍 [CompactStrategyMenu] 准备模态框数据:
   stepId: 1763521205492_49wp0fadk
 ...
 🔍 [CompactStrategyMenu] 准备模态框数据:
   ...
   dataLoading: false
   dataError: null
 🔍 Fallback 1 检查: {stepId: '1763521205492_49wp0fadk', cardId: 'card_1763521205827_ilm48hf3v', hasCard: true, hasOriginalElement: true, cardKeys: Array(11), …}
 ⚠️ Fallback 1: 使用步骤卡片数据 {id: 'element_27', element_type: 'content_other', text: '', bounds: {…}, resource_id: '', …}
 🔍 [菜单显示] Step1 - 卡片子树评分: {candidateKey: 'card_subtree_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
 🔍 [菜单显示] Step2 - 叶子上下文评分: {candidateKey: 'leaf_context_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
 🔍 [CompactStrategyMenu] 准备模态框数据:
 ...
 🔍 [菜单显示] Step2 - 叶子上下文评分: {candidateKey: 'leaf_context_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
 🔍 [CompactStrategyMenu] 准备模态框数据:
CompactStrategyMenu.tsx:1454   stepId: 1763521205492_49wp0fadk
...
CompactStrategyMenu.tsx:1468 🔍 Fallback 1 检查: {stepId: '1763521205492_49wp0fadk', cardId: 'card_1763521205827_ilm48hf3v', hasCard: true, hasOriginalElement: true, cardKeys: Array(11), …}
...
CompactStrategyMenu.tsx:1456   dataLoading: false
CompactStrategyMenu.tsx:1457   dataError: null
CompactStrategyMenu.tsx:1468 🔍 Fallback 1 检查: {stepId: '1763521205492_49wp0fadk', cardId: 'card_1763521205827_ilm48hf3v', hasCard: true, hasOriginalElement: true, cardKeys: Array(12), …}
CompactStrategyMenu.tsx:1477 ⚠️ Fallback 1: 使用步骤卡片数据 {id: 'element_27', element_type: 'content_other', text: '', bounds: {…}, resource_id: '', …}
strategy-menu-builder.tsx:312 🔍 [菜单显示] Step1 - 卡片子树评分: {candidateKey: 'card_subtree_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
strategy-menu-builder.tsx:312 🔍 [菜单显示] Step2 - 叶子上下文评分: {candidateKey: 'leaf_context_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
CompactStrategyMenu.tsx:1453 🔍 [CompactStrategyMenu] 准备模态框数据:
...
intelligent-analysis-backend-v3.ts:411 ✅ [V3 BackendService] 进度事件监听器已设置
intelligent-analysis-backend-v3.ts:422 🔧 [V3 BackendService] 设置完成事件监听器
devTracer.ts:42 [EVT] analysis:progress {job_id: 'ff23829c-5b1e-49c3-b056-1913692819d1', progress: 65, current_step: '生成智能策略', estimated_time_left: 1750}
analysis-state-store.ts:266 🚀 [AnalysisState] 开始新的分析任务 {jobId: '692819d1'}
devTracer.ts:42 [EVT] analysis:progress {job_id: 'ff23829c-5b1e-49c3-b056-1913692819d1', progress: 65, current_step: '生成智能策略', estimated_time_left: 1750}
strategy-menu-builder.tsx:312 🔍 [菜单显示] Step1 - 卡片子树评分: {candidateKey: 'card_subtree_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
strategy-menu-builder.tsx:312 🔍 [菜单显示] Step2 - 叶子上下文评分: {candidateKey: 'leaf_context_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
CompactStrategyMenu.tsx:1453 🔍 [CompactStrategyMenu] 准备模态框数据:
...
intelligent-analysis-backend-v3.ts:505 🧹 [V3 BackendService] 清理事件监听器 2
 🔍 [CompactStrategyMenu] 评分数据已更新: {stepId: '1763521205492_49wp0fadk', totalScores: 3, scores: Array(3)}
 ⏱️ [StrategyAnalysis] 开始15秒超时监控 {stepId: '1763521205492_49wp0fadk', currentTime: '2025-11-19T03:00:07.457Z', analysisState: {…}}
 🔧 [EventSetup] 使用V2事件监听系统
 🔍 [菜单显示] Step1 - 卡片子树评分: {candidateKey: 'card_subtree_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
 🔍 [菜单显示] Step2 - 叶子上下文评分: {candidateKey: 'leaf_context_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
 🔍 [CompactStrategyMenu] 准备模态框数据:
   ...
   dataLoading: false
   dataError: null
 🔍 Fallback 1 检查: {stepId: '1763521205492_49wp0fadk', cardId: 'card_1763521205827_ilm48hf3v', hasCard: true, hasOriginalElement: true, cardKeys: Array(12), …}
 ⚠️ Fallback 1: 使用步骤卡片数据 {id: 'element_27', element_type: 'content_other', text: '', bounds: {…}, resource_id: '', …}
 🔍 [菜单显示] Step1 - 卡片子树评分: {candidateKey: 'card_subtree_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
 🔍 [菜单显示] Step2 - 叶子上下文评分: {candidateKey: 'leaf_context_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
 🔍 [CompactStrategyMenu] 准备模态框数据:
 ...
 ✅ [ElementSelectionManager] 全局清理完成
 📐 [ZIndexManager] 注销模态框: universal-page-finder-modal {activeModals: Array(0), totalActive: 0}
...
devTracer.ts:42 [EVT] analysis:progress {job_id: 'ff23829c-5b1e-49c3-b056-1913692819d1', progress: 85, current_step: '评估策略质量', estimated_time_left: 750}
devTracer.ts:42 [EVT] analysis:progress {job_id: 'ff23829c-5b1e-49c3-b056-1913692819d1', progress: 85, current_step: '评估策略质量', estimated_time_left: 750}
strategy-menu-builder.tsx:312 🔍 [菜单显示] Step1 - 卡片子树评分: {candidateKey: 'card_subtree_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
strategy-menu-builder.tsx:312 🔍 [菜单显示] Step2 - 叶子上下文评分: {candidateKey: 'leaf_context_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
 🔍 [CompactStrategyMenu] 准备模态框数据:
 ...
 🔍 Fallback 1 检查: {stepId: '1763521205492_49wp0fadk', cardId: 'card_1763521205827_ilm48hf3v', hasCard: true, hasOriginalElement: true, cardKeys: Array(12), …}
 ⚠️ Fallback 1: 使用步骤卡片数据 {id: 'element_27', element_type: 'content_other', text: '', bounds: {…}, resource_id: '', …}
 🔍 [CompactStrategyMenu] 评分数据已更新: {stepId: '1763521205492_49wp0fadk', totalScores: 4, scores: Array(4)}
 🔧 [EventSetup] 使用V2事件监听系统
 🔍 [菜单显示] Step1 - 卡片子树评分: {candidateKey: 'card_subtree_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
 🔍 [菜单显示] Step2 - 叶子上下文评分: {candidateKey: 'leaf_context_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
 🔍 [CompactStrategyMenu] 准备模态框数据:
 ...
 🔍 Fallback 1 检查: {stepId: '1763521205492_49wp0fadk', cardId: 'card_1763521205827_ilm48hf3v', hasCard: true, hasOriginalElement: true, cardKeys: Array(12), …}
 ⚠️ Fallback 1: 使用步骤卡片数据 {id: 'element_27', element_type: 'content_other', text: '', bounds: {…}, resource_id: '', …}
 [EVT] analysis:progress {job_id: 'ff23829c-5b1e-49c3-b056-1913692819d1', progress: 95, current_step: '生成分析报告', estimated_time_left: 250}
 [EVT] analysis:progress {job_id: 'ff23829c-5b1e-49c3-b056-1913692819d1', progress: 95, current_step: '生成分析报告', estimated_time_left: 250}
 🔍 [菜单显示] Step1 - 卡片子树评分: {candidateKey: 'card_subtree_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
 🔍 [菜单显示] Step2 - 叶子上下文评分: {candidateKey: 'leaf_context_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
 🔍 [CompactStrategyMenu] 准备模态框数据:
 ...
 🔍 Fallback 1 检查: {stepId: '1763521205492_49wp0fadk', cardId: 'card_1763521205827_ilm48hf3v', hasCard: true, hasOriginalElement: true, cardKeys: Array(12), …}
CompactStrategyMenu.tsx:1477 ⚠️ Fallback 1: 使用步骤卡片数据 {id: 'element_27', element_type: 'content_other', text: '', bounds: {…}, resource_id: '', …}
devTracer.ts:42 [EVT] analysis:progress {job_id: 'ff23829c-5b1e-49c3-b056-1913692819d1', progress: 100, current_step: '分析完成', estimated_time_left: 0}
stepcards.ts:411 ✅ [StepCardStore] 分析完成，状态自动切换为ready {cardId: 'lm48hf3v', progress: 100}
devTracer.ts:42 [EVT] analysis:progress {job_id: 'ff23829c-5b1e-49c3-b056-1913692819d1', progress: 100, current_step: '分析完成', estimated_time_left: 0}
strategy-menu-builder.tsx:312 🔍 [菜单显示] Step1 - 卡片子树评分: {candidateKey: 'card_subtree_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
strategy-menu-builder.tsx:312 🔍 [菜单显示] Step2 - 叶子上下文评分: {candidateKey: 'leaf_context_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
CompactStrategyMenu.tsx:1453 🔍 [CompactStrategyMenu] 准备模态框数据:
...
devTracer.ts:42 [EVT] analysis:done {job_id: 'ff23829c-5b1e-49c3-b056-1913692819d1', selection_hash: '6e57b50d12fa', result: {…}, confidence: 0.8811, evidence: {…}, …}
devTracer.ts:42 [EVT] analysis:done {job_id: 'ff23829c-5b1e-49c3-b056-1913692819d1', selection_hash: '6e57b50d12fa', result: {…}, confidence: 0.8811, evidence: {…}, …}
wire-global-events.ts:193 🎯 [ROUTE] 从smart_candidates提取最终分数 {jobId: '692819d1', cardId: 'lm48hf3v', candidatesCount: 2}
step-score-store.ts:187 🎯 [StepScoreStore] 设置候选项评分 {stepId: '1763521205492_49wp0fadk', candidateKey: 'self_anchor', confidence: '88%', rawInput: 0.8811}
step-score-store.ts:187 🎯 [StepScoreStore] 设置候选项评分 {stepId: '1763521205492_49wp0fadk', candidateKey: 'xpath_fallback', confidence: '55%', rawInput: 0.5455000299999999}
wire-global-events.ts:243 🔗 [ROUTE] 生成基于候选项的智能自动链 {jobId: '692819d1', recommended: 'self_anchor', stepsCount: 2}
analysis-state-store.ts:276 🏆 [AnalysisState] 分析任务完成 {jobId: '692819d1', totalSteps: 4}
stepcards.ts:448 ✅ [StepCardStore] 填充策略并就绪 {cardId: 'card_1763521205827_ilm48hf3v', strategy: {…}}
wire-global-events.ts:308 🔧 [Wire Events] 调用 setSingleStepConfidence {targetCardId: 'lm48hf3v', rawConfidence: 0.8811, normalizedConfidence: 0.8811, confidence: 0.8811, source: 'auto_chain', …}
stepcards.ts:531 🎯 [StepCardStore] 设置单步置信度 {cardId: 'lm48hf3v', confidence: 0.8811, confidencePercent: '88%', source: 'auto_chain', finalStatus: 'ready', …}
stepcards.ts:505 📊 [StepCardStore] 设置置信度 {cardId: 'card_1763521205827_ilm48hf3v', confidence: 0.8811, evidence: {…}}
wire-global-events.ts:339 📊 [Wire Events] 写入候选项评分 {stepId: '9wp0fadk', smartCandidates: 2, candidateKeys: Array(2), recommendedKey: 'self_anchor', globalConfidence: 0.8811}
...
step-score-store.ts:187 🎯 [StepScoreStore] 设置候选项评分 {stepId: '1763521205492_49wp0fadk', candidateKey: 'self_anchor', confidence: '88%', rawInput: 88.11}
wire-global-events.ts:361 ✅ [Wire Events] 候选分写入验证 {stepId: '9wp0fadk', candidateKey: 'self_anchor', written: 88.11, readBack: 0.8811, success: false}
...
step-score-store.ts:187 🎯 [StepScoreStore] 设置候选项评分 {stepId: '1763521205492_49wp0fadk', candidateKey: 'xpath_fallback', confidence: '55%', rawInput: 54.550003}
wire-global-events.ts:361 ✅ [Wire Events] 候选分写入验证 {stepId: '9wp0fadk', candidateKey: 'xpath_fallback', written: 54.550003, readBack: 0.5455000299999999, success: false}
step-score-store.ts:161 🌐 [StepScoreStore] 设置全局评分 {stepId: '1763521205492_49wp0fadk', confidence: '88%', rawInput: 0.8811}
step-score-store.ts:113 📊 [StepScoreStore] 更新评分缓存 {key: 'element:1763521205492_49wp0fadk', confidence: '88%', origin: 'single', recommended: 'self_anchor'}
VM1046:286  [TAURI] Couldn't find callback id 481780216. This might happen when the app is reloaded while Rust is running an asynchronous operation.
runCallback @ VM1046:286
value @ VM1046:366
(匿名) @ VM2043:1
(匿名) @ VM2043:1
strategy-menu-builder.tsx:312 🔍 [菜单显示] Step1 - 卡片子树评分: {candidateKey: 'card_subtree_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
...
CompactStrategyMenu.tsx:1456   dataLoading: false
CompactStrategyMenu.tsx:1457   dataError: null
CompactStrategyMenu.tsx:1468 🔍 Fallback 1 检查: {stepId: '1763521205492_49wp0fadk', cardId: 'card_1763521205827_ilm48hf3v', hasCard: true, hasOriginalElement: true, cardKeys: Array(16), …}
CompactStrategyMenu.tsx:1477 ⚠️ Fallback 1: 使用步骤卡片数据 {id: 'element_27', element_type: 'content_other', text: '', bounds: {…}, resource_id: '', …}
strategy-menu-builder.tsx:312 🔍 [菜单显示] Step1 - 卡片子树评分: {candidateKey: 'card_subtree_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
strategy-menu-builder.tsx:312 🔍 [菜单显示] Step2 - 叶子上下文评分: {candidateKey: 'leaf_context_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
CompactStrategyMenu.tsx:1453 🔍 [CompactStrategyMenu] 准备模态框数据:
...
CompactStrategyMenu.tsx:1468 🔍 Fallback 1 检查: {stepId: '1763521205492_49wp0fadk', cardId: 'card_1763521205827_ilm48hf3v', hasCard: true, hasOriginalElement: true, cardKeys: Array(16), …}
CompactStrategyMenu.tsx:1477 ⚠️ Fallback 1: 使用步骤卡片数据 {id: 'element_27', element_type: 'content_other', text: '', bounds: {…}, resource_id: '', …}
useSmartStrategyAnalysis.ts:100 🧹 [StrategyAnalysis] 清理超时监控 {stepId: '1763521205492_49wp0fadk'}
CompactStrategyMenu.tsx:258 🔍 [CompactStrategyMenu] 评分数据已更新: {stepId: '1763521205492_49wp0fadk', totalScores: 4, scores: Array(4)}
use-intelligent-analysis-workflow.ts:214 🔧 [EventSetup] 使用V2事件监听系统
strategy-menu-builder.tsx:312 🔍 [菜单显示] Step1 - 卡片子树评分: {candidateKey: 'card_subtree_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
strategy-menu-builder.tsx:312 🔍 [菜单显示] Step2 - 叶子上下文评分: {candidateKey: 'leaf_context_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
CompactStrategyMenu.tsx:1453 🔍 [CompactStrategyMenu] 准备模态框数据:
...
CompactStrategyMenu.tsx:1468 🔍 Fallback 1 检查: {stepId: '1763521205492_49wp0fadk', cardId: 'card_1763521205827_ilm48hf3v', hasCard: true, hasOriginalElement: true, cardKeys: Array(16), …}
CompactStrategyMenu.tsx:1477 ⚠️ Fallback 1: 使用步骤卡片数据 {id: 'element_27', element_type: 'content_other', text: '', bounds: {…}, resource_id: '', …}
 🎯 [自动评分] 开始执行Step1-2评分 {stepId: '1763521205492_49wp0fadk', cardId: 'card_1763521205827_ilm48hf3v'}
 🎯 [智能·自动链] 触发结构匹配评分 {steps: Array(2), forceRefresh: false, source: 'smart_auto_chain'}
 🔍 [智能·自动链] 卡片数据检查: {cardId: 'card_1763521205827_ilm48hf3v', hasElementContext: true, elementContextKeys: Array(5), xpath: '//element_27', hasXmlSnapshot: true, …}
 📦 [智能·自动链] 开始加载XML缓存 {cardId: 'lm48hf3v', hasXmlCacheId: true, hasEmbeddedXml: true}
 🔍 [菜单显示] Step1 - 卡片子树评分: {candidateKey: 'card_subtree_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
 🔍 [菜单显示] Step2 - 叶子上下文评分: {candidateKey: 'leaf_context_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
 🔍 [CompactStrategyMenu] 准备模态框数据:
   stepId: 1763521205492_49wp0fadk
   ...
   dataLoading: false
   dataError: null
 🔍 Fallback 1 检查: {stepId: '1763521205492_49wp0fadk', cardId: 'card_1763521205827_ilm48hf3v', hasCard: true, hasOriginalElement: true, cardKeys: Array(16), …}
 ⚠️ Fallback 1: 使用步骤卡片数据 {id: 'element_27', element_type: 'content_other', text: '', bounds: {…}, resource_id: '', …}
 🔍 [菜单显示] Step1 - 卡片子树评分: {candidateKey: 'card_subtree_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
 🔍 [菜单显示] Step2 - 叶子上下文评分: {candidateKey: 'leaf_context_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
 🔍 [CompactStrategyMenu] 准备模态框数据:
 ...
 🔍 Fallback 1 检查: {stepId: '1763521205492_49wp0fadk', cardId: 'card_1763521205827_ilm48hf3v', hasCard: true, hasOriginalElement: true, cardKeys: Array(16), …}
 ⚠️ Fallback 1: 使用步骤卡片数据 {id: 'element_27', element_type: 'content_other', text: '', bounds: {…}, resource_id: '', …}
 ⚡ XML缓存加载快速: 0ms (来源: memory)
 ✅ [智能·自动链] 从xmlCacheId恢复XML成功 {xmlCacheId: 'ui_dump_e0d909c3_20251030_122312.xml', xmlLength: 38755}
 🔄 [智能·自动链] 调用后端评分接口 {xpath: '//element_27', indexPath: Array(22), indexPathLength: 22, requestedSteps: Array(2), xmlLength: 38755}
 🚀 [智能·自动链] 开始调用 recommend_structure_mode_v2...
 🔍 [菜单显示] Step1 - 卡片子树评分: {candidateKey: 'card_subtree_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
 🔍 [菜单显示] Step2 - 叶子上下文评分: {candidateKey: 'leaf_context_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
 🔍 [CompactStrategyMenu] 准备模态框数据:
   stepId: 1763521205492_49wp0fadk
 ...
 🔍 Fallback 1 检查: {stepId: '1763521205492_49wp0fadk', cardId: 'card_1763521205827_ilm48hf3v', hasCard: true, hasOriginalElement: true, cardKeys: Array(16), …}
 ⚠️ Fallback 1: 使用步骤卡片数据 {id: 'element_27', element_type: 'content_other', text: '', bounds: {…}, resource_id: '', …}
 🔄 [adbStore] setDevices 被调用: {deviceCount: 0, deviceIds: Array(0)}
 ✅ [adbStore] devices 状态已更新
 👁️ [AdbApplicationService] 启动设备监听服务...
 🔌 [RealTimeDeviceRepository] 移除设备变化监听器: {callbackCount: 0}
 🔗 [RealTimeDeviceRepository] 注册设备变化监听器: {callbackCount: 1}
 ✅ [RealTimeDeviceRepository] 监听器健康检查通过，回调数量: 2
 🏥 [AdbHealthService] 启动健康检查...
 🔍 [菜单显示] Step1 - 卡片子树评分: {candidateKey: 'card_subtree_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
 🔍 [菜单显示] Step2 - 叶子上下文评分: {candidateKey: 'leaf_context_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
 🔍 [CompactStrategyMenu] 准备模态框数据:
   stepId: 1763521205492_49wp0fadk
 ...
 🔍 Fallback 1 检查: {stepId: '1763521205492_49wp0fadk', cardId: 'card_1763521205827_ilm48hf3v', hasCard: true, hasOriginalElement: true, cardKeys: Array(16), …}
 ⚠️ Fallback 1: 使用步骤卡片数据 {id: 'element_27', element_type: 'content_other', text: '', bounds: {…}, resource_id: '', …}
 🔍 [AdbHealthService] 定期诊断检查已启动
 ✅ [AdbApplicationService] ADB环境初始化完成
 🔍 [菜单显示] Step1 - 卡片子树评分: {candidateKey: 'card_subtree_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
 🔍 [菜单显示] Step2 - 叶子上下文评分: {candidateKey: 'leaf_context_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
 🔍 [CompactStrategyMenu] 准备模态框数据:
CompactStrategyMenu.tsx:1454   stepId: 1763521205492_49wp0fadk
...
CompactStrategyMenu.tsx:1477 ⚠️ Fallback 1: 使用步骤卡片数据 {id: 'element_27', element_type: 'content_other', text: '', bounds: {…}, resource_id: '', …}
stepcards.ts:448 ✅ [StepCardStore] 填充策略并就绪 {cardId: 'card_1763521205827_ilm48hf3v', strategy: {…}}
use-intelligent-analysis-workflow.ts:437 🔗 [Bridge] 同步完成状态到统一store {cardId: 'card_1763521205827_ilm48hf3v', jobId: 'ff23829c-5b1e-49c3-b056-1913692819d1', strategy: {…}}
strategy-menu-builder.tsx:312 🔍 [菜单显示] Step1 - 卡片子树评分: {candidateKey: 'card_subtree_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
strategy-menu-builder.tsx:312 🔍 [菜单显示] Step2 - 叶子上下文评分: {candidateKey: 'leaf_context_scoring', confidence: null, displayScore: undefined, confidencePercent: undefined, hasScore: false}
CompactStrategyMenu.tsx:1453 🔍 [CompactStrategyMenu] 准备模态框数据:
CompactStrategyMenu.tsx:1454   stepId: 1763521205492_49wp0fadk
...
CompactStrategyMenu.tsx:1468 🔍 Fallback 1 检查: {stepId: '1763521205492_49wp0fadk', cardId: 'card_1763521205827_ilm48hf3v', hasCard: true, hasOriginalElement: true, cardKeys: Array(16), …}
CompactStrategyMenu.tsx:1477 ⚠️ Fallback 1: 使用步骤卡片数据 {id: 'element_27', element_type: 'content_other', text: '', bounds: {…}, resource_id: '', …}
event-acknowledgment-service.ts:69  ⚠️ [EventAck] 发送确认失败（非致命） {eventType: 'analysis:done', eventId: 'ff23829c-5b1e-49c3-b056-1913692819d1', error: 'Command acknowledge_event not found'}
acknowledgeEvent @ event-acknowledgment-service.ts:69
use-intelligent-analysis-workflow.ts:458 ✅ [Workflow] 完成事件处理并已确认 {jobId: 'ff23829c-5b1e-49c3-b056-1913692819d1'}
shared-scoring.ts:213 ✅ [智能·自动链] 后端返回 3 个评分结果 {outcomes: Array(3)}
shared-scoring.ts:234 ✅ [智能·自动链] 卡片子树评分完成: 25.0%
shared-scoring.ts:234 ✅ [智能·自动链] 叶子上下文评分完成: 22.0%
...
(匿名) @ use-intelligent-analysis-workflow.ts:975
strategy-menu-builder.tsx:312 🔍 [菜单显示] Step1 - 卡片子树评分: {candidateKey: 'card_subtree_scoring', confidence: 0.25, displayScore: 0.25, confidencePercent: 25, hasScore: true}
strategy-menu-builder.tsx:312 🔍 [菜单显示] Step2 - 叶子上下文评分: {candidateKey: 'leaf_context_scoring', confidence: 0.22, displayScore: 0.22, confidencePercent: 22, hasScore: true}
CompactStrategyMenu.tsx:1453 🔍 [CompactStrategyMenu] 准备模态框数据:
CompactStrategyMenu.tsx:1454   stepId: 1763521205492_49wp0fadk
CompactStrategyMenu.tsx:1455   unifiedElementData: null
CompactStrategyMenu.tsx:1456   dataLoading: false
...
CompactStrategyMenu.tsx:1468 🔍 Fallback 1 检查: {stepId: '1763521205492_49wp0fadk', cardId: 'card_1763521205827_ilm48hf3v', hasCard: true, hasOriginalElement: true, cardKeys: Array(16), …}
CompactStrategyMenu.tsx:1477 ⚠️ Fallback 1: 使用步骤卡片数据 {id: 'element_27', element_type: 'content_other', text: '', bounds: {…}, resource_id: '', …}
CompactStrategyMenu.tsx:258 🔍 [CompactStrategyMenu] 评分数据已更新: {stepId: '1763521205492_49wp0fadk', totalScores: 6, scores: Array(6)}
use-intelligent-analysis-workflow.ts:976 ✅ [自动评分] Step1-2评分完成 {stepId: '1763521205492_49wp0fadk'}
