...
pub async fn perform_intelligent_strategy_analysis_from_raw(
    ...
    use crate::automation::adapters::device as device_manager;
    use crate::automation::analysis::intelligent::*;
    use crate::automation::analysis::strategy_gen::{
...
async fn call_frontend_intelligent_analysis_with_context(
    user_intent: &crate::automation::analysis::intelligent::UserIntent,
    ui_xml: &str,
    device_id: &str,
    original_params: &serde_json::Value,
    ...
    let steps = crate::automation::analysis::strategy_gen::convert_analysis_result_to_v3_steps_with_config(
        analysis_result,
...
pub async fn call_frontend_intelligent_analysis(
    ...
    use crate::automation::analysis::strategy_gen::convert_analysis_result_to_v3_steps;
