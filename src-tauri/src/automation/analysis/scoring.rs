...
use crate::automation::types::{StepRefOrInline, SingleStepAction, QualitySettings};
// ✅ 已迁移到V3智能匹配系统
// use crate::services::legacy_simple_selection_engine::SmartSelectionEngine;
use crate::automation::pipeline::protocol::create_smart_selection_protocol_for_scoring;
