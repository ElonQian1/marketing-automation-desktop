...
use crate::automation::events::emit_progress;
use crate::automation::types::Phase;
use crate::automation::analysis::utils::{
...
use crate::automation::analysis::optimization::merge_and_optimize_steps;
use crate::automation::types::SingleStepAction;
use tauri::AppHandle;
