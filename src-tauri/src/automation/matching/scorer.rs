// src-tauri/src/automation/matching/scorer.rs
// module: automation | layer: matching | role: 多候选评估器
// summary: 对多个XPath匹配结果进行综合评分，选择最佳候选

use crate::services::universal_ui_page_analyzer::UIElement;
use crate::exec::element_matching::text_comparator::TextComparator;
...
impl MultiCandidateEvaluator {
    ...
    fn score_candidate(
        ...
        use crate::exec::element_matching::xpath_similarity_matcher::XPathSimilarityMatcher;
        ...
        if should_use_xpath_mode {
            ...
            if let Some(ref original_bounds) = &criteria.original_bounds {
                ...
                use crate::exec::element_matching::bounds_matcher::BoundsMatcher;
