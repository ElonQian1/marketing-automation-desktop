...
import { ImportEventData } from "../types/ImportEvent";
import {
  Contact,
  ContactDeviceGroup,
  Device,
...
// 保持向后兼容性的别名
export const ContactImporter = ContactImporterUseCase;
export type { ContactImporterOptions as ContactImporterUseCaseOptions };