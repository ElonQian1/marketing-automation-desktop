...
import { Space, Button, Progress, Alert, Tag, Typography } from "antd";
import {
  LoadingOutlined,
  TrophyOutlined,
  EyeOutlined,
      ...
      <div
        style={{
          background: isHighConfidence
            ? "var(--success-bg, #f6ffed)"
            : "var(--warning-bg, #fffbe6)",
          border: `1px solid ${
            isHighConfidence
              ? "var(--success-border, #b7eb8f)"
              : "var(--warning-border, #ffe58f)"
          }`,
          borderRadius: 8,
          padding: 12,
          marginBottom: 16,
      ...
      >
        <Space direction="vertical" style={{ width: "100%" }} size="small">
          ...
          >
            <Space>
              <TrophyOutlined
                style={{ color: isHighConfidence ? "#52c41a" : "#faad14" }}
              />
              <Text strong style={{ fontSize: 13 }}>
