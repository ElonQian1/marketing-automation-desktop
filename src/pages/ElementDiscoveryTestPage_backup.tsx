...
import { Card, Button, Space, Typography, Alert, Divider, Row, Col, Upload, message } from 'antd';
import { FileTextOutlined, PlayCircleOutlined, UploadOutlined } from '@ant-design/icons';
import { ElementDiscoveryModal } from '../components/universal-ui/element-selection/element-discovery/ElementDiscoveryModal';
import { UIElement } from '../api/universal-ui/types';
