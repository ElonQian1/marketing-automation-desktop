...
export class EmployeeAPI {
  ...
  static async getEmployees(): Promise<EmployeeData[]> {
    try {
      return await invoke<EmployeeData[]>('plugin:employees|list');
    } catch (error) {
  ...
  static async addEmployee(employee: EmployeeFormData): Promise<EmployeeData> {
    try {
      return await invoke<EmployeeData>('plugin:employees|add', { employee });
    } catch (error) {
  ...
  static async updateEmployee(employee: EmployeeData): Promise<EmployeeData> {
    try {
      return await invoke<EmployeeData>('plugin:employees|update', { employee });
    } catch (error) {
  ...
  static async deleteEmployee(id: number): Promise<void> {
    try {
      await invoke<void>('plugin:employees|delete', { id });
    } catch (error) {
